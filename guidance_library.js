...
// Professional Guidance Library - AI-generated variations
const guidanceLibrary = {
  "version": "2.0.0",
  "generated_date": "2025-08-17T13:06:48.841545",
  ...
  "statistics": {
    "total_intent_variations": 80,
    "total_style_variations": 80,
    "intents_count": 16,
    "styles_count": 16
  }
};
...
// Get random guidance
function getRandomGuidance(type, key) {
    const guidances = type === 'intent' 
        ? guidanceLibrary.editing_intents[key] 
        : guidanceLibrary.processing_styles[key];
    
    if (!guidances || guidances.length === 0) {
        return type === 'intent' ? 'general image editing' : 'professional quality';
    }
...
// Update getIntentGuidance function
getIntentGuidance(intent) {
    return getRandomGuidance('intent', intent);
}

// Update getStyleGuidance function  
